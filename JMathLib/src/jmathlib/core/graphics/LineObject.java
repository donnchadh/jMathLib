...
public class LineObject extends GraphicalObject implements PropertyListener
{
	...
	// properties 
    protected ColorProperty ColorP = new ColorProperty(this, "Color", Color.red);
    // protected EraseModeP
    // protected LineStyleP
    // protected LineWidthP
    protected MarkerProperty MarkerP = new MarkerProperty(this, "Marker", "none");
    // protected MarkerEdgeColorP
    // protected MarkerFaceColorP
    protected DoubleProperty MarkerSizeP = new DoubleProperty(this, "MarkerSize", 9.0);
    // protected UIContextMenuP
    protected DoubleArrayProperty XDataP = new DoubleArrayProperty(this, "XData", new double[0], -1);
    protected DoubleArrayProperty YDataP = new DoubleArrayProperty(this, "YData", new double[0], -1);
    protected DoubleArrayProperty ZDataP = new DoubleArrayProperty(this, "ZData", new double[0], -1);;
    ...
    protected RadioProperty TypeP = new RadioProperty(this, "Type", new String[] {"Line", "Stem","Stair","Area"},"Line");
